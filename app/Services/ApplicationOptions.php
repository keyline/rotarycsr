    ...
    public static function rulesForStep(string $applicantType, string $stepKey): array
    {
        return match ($stepKey) {
            ...
            'nomination' => [
                ...
                'primary_contact_email' => ['required', 'email:rfc', 'max:255'],
                'primary_contact_mobile' => ['required', 'digits:10'],
                ...
                'secondary_contact_email' => ['nullable', 'required_with:secondary_contact_name,secondary_contact_designation,secondary_contact_mobile', 'email:rfc', 'max:255'],
                'secondary_contact_mobile' => ['nullable', 'required_with:secondary_contact_name,secondary_contact_designation,secondary_contact_email', 'digits:10'],
            ],
            'assessment' => [
